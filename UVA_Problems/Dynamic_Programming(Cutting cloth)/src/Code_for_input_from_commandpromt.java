...
public class Code_for_input_from_commandpromt {

	public static void main(String[] args) {
		Scanner x = new Scanner(System.in);
		System.out.println("Give input for X and Y: ");
		...
		System.out.println("Give input for number of templates: ");
		int n=x.nextInt();
		System.out.println("Give template values one by one: ");
